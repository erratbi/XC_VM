...
Здесь собраны ответы на наиболее частые вопросы и проблемы при работе с XtreamPi.
...
3. **Если полностью заблокированы:** Используйте `console.php tools rescue` для создания кода восстановления доступа (см. [CLI-инструменты](ru-ru/guides/cli-tools.md)).
...
<details>
<summary><b>❌ Приставка блокируется после сброса/смены прошивки (изменился serial или device_id, а в панели прописан старый)</b></summary>
...
Подробности: [Миграции БД](ru-ru/guides/cli-tools.md#обновление-бд-после-обновления-версии).
...
XtreamPi запускает **два** инстанса nginx:
