(function () {
	...
	function load() {
		...
		params.set('draw', String(sequence)); params.set('id', 'live_connections'); params.set('view', 'xtreampi'); params.set('start', String((page - 1) * size)); params.set('length', String(size)); params.set('search[value]', search ? search.value.trim() : ''); params.set('server_id', server.value); params.set('order[0][column]', '8'); params.set('order[0][dir]', 'desc');
