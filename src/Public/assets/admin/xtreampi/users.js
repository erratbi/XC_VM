(function () {
	...
	function load() {
		...
		params.set('draw', String(sequence)); params.set('id', 'reg_users'); params.set('view', 'xtreampi'); params.set('start', String((page - 1) * size)); params.set('length', String(size)); params.set('search[value]', search.value.trim()); params.set('filter', filter.value); params.set('order[0][column]', '0'); params.set('order[0][dir]', 'desc');
