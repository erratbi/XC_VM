...
$xtreampiPageScripts = ['assets/xtreampi/connections.js'];
$xtreampiServers = array_filter(ServerRepository::getAll(), static fn(array $server): bool => !empty($server['enabled']));
...
?>
<section class="sc-connections" data-sc-connections data-endpoint="table" data-default-entries="<?php echo $xtreampiDefaultEntries; ?>" data-can-lines="<?php echo $xtreampiConnectionPermissions['lines'] ? '1' : '0'; ?>" data-can-mags="<?php echo $xtreampiConnectionPermissions['mags'] ? '1' : '0'; ?>" data-can-enigmas="<?php echo $xtreampiConnectionPermissions['enigmas'] ? '1' : '0'; ?>" data-can-hmacs="<?php echo $xtreampiConnectionPermissions['hmacs'] ? '1' : '0'; ?>" data-can-servers="<?php echo $xtreampiConnectionPermissions['servers'] ? '1' : '0'; ?>">
