...
if (isset($rServerArr) && $rServerArr['is_main'] == 1) {
    echo '                        <div class="alert alert-danger" role="alert">' . "\n" . '                            This is your main server, you cannot reinstall it from the XtreamPi panel. To reinstall this server, please use the installation instructions on the billing panel.' . "\n" . '                        </div>' . "\n" . '                        ';
} else {
    ...
    if (isset($rServerArr) && isset(RequestManager::getAll()['update'])) {
        echo '                                                <div class="alert alert-info" role="alert">' . "\n" . '                                                    In order to update your XtreamPi core from v';
        ...
        if ($rType == 1) {
            echo '                                                    You will not be able to change the port or any other settings through the XtreamPi Admin Panel after installation, you will be required to reinstall the proxy server entirely.<br/><br/>Installation will begin immediately, you will be alerted of progress on the Server View page.' . "\n" . '                                                    ';
        } else {
