...
function generateError($rError, $rKill = true, $rCode = null) {
    ...
    if (isset($rSettings['debug_show_errors']) && $rSettings['debug_show_errors']) {
        ...
        echo '<html><head><title>XtreamPi - Debug Mode</title><link href="https://fonts.googleapis.com/css?family=Montserrat:200,400,700" rel="stylesheet"><style>' . $rStyle . '</style></head><body><div id="notfound"><div class="notfound"><div class="notfound-404"><h1>XtreamPi</h1><h2>' . $rError . '</h2><br/></div><p>' . $rErrorDescription . '</p></div></div></body></html>';
